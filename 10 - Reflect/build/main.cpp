...
int main () {
  ...
  auto material_bubble = make_shared<dielectric>(1.00/1.50); // hollow glass effect
  ...
  world.add(make_shared<sphere>(point3(-1., 0.0,    -1), 0.4, material_bubble));
